<script setup>
let urlProduct = "http://localhost/vuejs-server/api.php/api.php/products";
let urlCategory = "http://localhost/vuejs-server/api.php/api.php/categories";
let urlImage = "http://localhost/vuejs-server/api.php/uploads/product/";
